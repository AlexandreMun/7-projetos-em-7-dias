document.querySelector(".busca").addEventListener("submit", async (e) => {
  ...
  if (input !== "") {
    ...
    let url = `api.openweathermap.org/data/2.5/weather?q=${encodeURI(
      input
    )}&appid=cdd7b59113c9de6090a1cf2f69bb21bd&units=metric&lang=pt_br`;
    ...
    clearInfo();
    showWarning("Digite o nome da cidade");
  }
});
